 ...
 * 
 * @returns {any[]} Un array con dos elementos: en la posición [0], un MessageEmbed con la imagen y frase 
 * aleatorias; y en la posición [1], la imagen aleatoria de Fernando Almeida como MessageAttachment.
 */
